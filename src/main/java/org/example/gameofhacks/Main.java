...
/**
 * See klass on mängu põhikäivitaja ja haldab kogu kasutajaliidest.
 * Kuvab esmalt laadimisekraani koos ASCII animatsiooniga,
 * seejärel terminali ja märkmete paneeliga mänguliidese.
 * Haldab käsude töötlemist, tasemete vahetamist, mängulogi kirjutamist ja vihikulehtede kuvamist.
 */
...
public class Main extends Application {
    ...
    // Määra mänguakna ikoon ja kuva splash-ekraan
    @Override
    ...
    // Kuvab musta taustaga splash-ekraani ja laadimistekstid
    ...
    // Mängib ASCII animatsiooni ja käivitab vaiketaseme
    ...
    // Töö Failiga
    // Salvestab logisõnumi ajatempli ja failiga
    ...
    // Käivitab mängutaseme ja uuendab terminali liidest
    ...
    // Loob terminaliliidese ja käsitleb klaviatuuri sisestust
    ...
    // Käivitab vilkuva kursori animatsiooni terminalis
    ...
    // Uuendab terminali vaadet ja vilkuvat kursorit
    ...
    // Liigub vihikulehtede vahel edasi või tagasi
    ...
    // Kuvab aktiivse vihikulehe sisu ja pealkirja
    ...
    // Töötleb kasutaja käsud: taseme valimine, logide vaatamine või väljaminek.
    // Kontrollib, kas sisend vastab tuntud käsule (nt "hack", "exit", "showlog"),
    // käivitab vastava tegevuse ja uuendab terminali kuva.
    // Kui tase saab lahendatud, suunatakse mängija tagasi algmenüüsse.
